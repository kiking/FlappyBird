...
class RateTableViewController: UITableViewController
{
    ...
    var difficulty=["crazy","hard","difficult","general","ordinary"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        // Configure the cell...
        cell.textLabel?.text=difficulty[indexPath.row]
        cell.textLabel?.textColor=UIColor.orange
        cell.accessoryType=UITableViewCellAccessoryType.none
        cell.selectionStyle=UITableViewCellSelectionStyle.none  //设置表格选择样式,不显示选中的样式
        if cell.textLabel?.text == UserDefaults.standard.string(forKey: UserDefaultKeys.difficulty)
        {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        {
            UserDefaults.standard.set(cell.textLabel?.text, forKey: UserDefaultKeys.difficulty)
        }
